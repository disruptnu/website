...
export const Pillar = [
  {
    ...
    description:
      "Fintech is the introduction of technology to elevate financial services.",
    alt: "",
  },
  {
    key: "pillar2",
    ...
    description:
      "Our community is made up of students, alumni, and professionals with a passion for Fintech.",
    alt: "",
  },
  {
    key: "pillar3",

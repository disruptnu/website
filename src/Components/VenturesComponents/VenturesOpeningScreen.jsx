...
export default function VenturesOpeningScreen() {
  return (
    <div className="relative flex flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center w-full px-4 pt-10 pb-10 sm:items-end sm:pt-28 sm:pb-20 sm:w-8/12 md:w-5/12">
        ...
        <p
          className="pb-5 text-4xl text-white sm:text-8xl sm:pb-8 heading-display"
          style={{ fontFamily: "Faucet" }}
        >
          FINNOVATE
        </p>
        <p
          className="mx-auto text-justify text-white leading-relaxed max-w-3xl font-usual-regular"
        >
      ...
      <div className="items-center mb-40">
        <p className="justify-center pt-12 pb-4 text-sm text-white font-usual-light">
          READ MORE
        </p>

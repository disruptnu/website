...
export default function PastVenturesOpeningScreen({ hamburgerMenuOpen, toggleHamburgerMenu}) {
            ...
            <div className="w-screen h-screen relative">
                ...
                <div className="w-screen h-3/4 flex flex-col justify-center items-center">
                    <div className=" w-auto flex flex-col items-cente justify-center">
                        <p className="h-3/4 text-white font-semibold text-120"
                            style={{fontFamily: 'Faucet', fontFeatureSettings: "'dlig' on, 'ss01' on"}}>
                            PAST VENTURES
                        </p>
                        <p className="text-white text-2xl self-end"

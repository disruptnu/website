    ...
    <div>
      <div className="relative flex flex-col items-center justify-center w-full">
        ...
        >
          ...
          <p
            className="flex-col pb-8 text-4xl text-white sm:text-2xl md:text-5xl heading-display"
          >
            CONSULTING
          </p>
          <p
            className="mx-auto text-justify text-white max-w-3xl text-sm sm:text-base md:text-lg font-usual-regular"
            style={{ hyphens: "auto" }}
          >
      ...
      <div className="mt-12 flex justify-center sm:justify-end mr-0 sm:mr-16">
        <button onClick={scrollDown} aria-label="Scroll to bottom">
          <img
            src={arrowDown}
            alt=""
